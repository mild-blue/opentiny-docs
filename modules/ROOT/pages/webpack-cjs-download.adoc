= Bundling a .zip version of OpenTiny with CommonJS and Webpack
:navtitle: CommonJS and a .zip archive
:description_short: Bundling a .zip archive version of OpenTiny in a project using CommonJS and Webpack
:description: Bundling a .zip archive version of OpenTiny in a project using CommonJS and Webpack
