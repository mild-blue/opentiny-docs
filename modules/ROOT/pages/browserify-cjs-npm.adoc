= Bundling an npm version of OpenTiny with CommonJS and Browserify
:navtitle: CommonJS and npm
:description_short: Bundling an npm version of OpenTiny in a project using CommonJS and Browserify
:description: Bundling an npm version of OpenTiny in a project using CommonJS and Browserify
...
* (Optional: For premium features) The latest premium `+.zip+` bundle of OpenTiny for including premium plugins
