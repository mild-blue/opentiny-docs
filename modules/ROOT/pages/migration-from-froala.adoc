= Migrating from Froala to OpenTiny
:navtitle: Migrating from Froala
:description: Upgrading your rich text editor from Froala Editor v3 to OpenTiny 6.
...
== Migrating a Basic Froala Configuration to OpenTiny
...
=== Replace Froala links and source script with a OpenTiny source script
...
==== OpenTiny 6 - A Basic Configuration
...
==== OpenTiny 6 - Creating a Custom Toolbar Layout
...
==== OpenTiny 6 - Configuring Inline Mode

[source,html]
----
<h3>OpenTiny Inline Mode</h3>
  <form method='post'>
...
==== OpenTiny 6 - Creating a Custom Toolbar Button
...
==== OpenTiny 6 - Creating a Custom Drop-down Button
