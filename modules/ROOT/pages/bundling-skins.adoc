= Bundling OpenTiny skins using module loading
:navtitle: Skins
:description_short: Information on bundling OpenTiny skins
:description: Information on bundling OpenTiny skins using module loading
