...
:description: OpenTiny provides a range of configuration options that allow you to integrate it into your application.
...
For a full list of plugins and their options, see: xref:plugins.adoc[Add plugins to OpenTiny].
...
* For information on Plugins and their options, see: xref:work-with-plugins.adoc[Add plugins to OpenTiny].
