...
:description_short: Security information for OpenTiny.
:description: Information on reporting security issues, what OpenTiny does to protect users, and what you can do to protect your users.
...
* xref:reporting-tinymce-security-issues[Reporting OpenTiny security issues]
* xref:what-we-do-to-maintain-security-for-tinymce[What we do to maintain security for OpenTiny]
...
* xref:configuring-content-security-policy-csp-for-tinymce[Configuring Content Security Policy (CSP) for OpenTiny]
...
** xref:securing-embedded-external-resources[Securing embedded external resources]
...
== [[reportingtinymcesecurityissues]] Reporting OpenTiny security issues
...
From the 1st of January 2020, Security Advisories for patched XSS vulnerabilities will be published on the https://github.com/mild-blue/opentiny/security/advisories?state=published[{productname} GitHub repository Security page].

[[keeping-dependencies-up-to-date]]
=== Keeping dependencies up-to-date

To protect our users, {companyname} ensures that the OpenTiny dependencies are updated before the next version (major or minor) is released.
