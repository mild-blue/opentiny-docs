= Bundling an npm version of OpenTiny with CommonJS and Webpack
:navtitle: CommonJS and npm
:description_short: Bundling an npm version of OpenTiny in a project using CommonJS and Webpack
:description: Bundling an npm version of OpenTiny in a project using CommonJS and Webpack
