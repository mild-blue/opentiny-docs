= Bundling a .zip version of OpenTiny with ES6 and Rollup.js
:navtitle: ES6 and a .zip archive
:description_short: Bundling a .zip archive version of OpenTiny in a project using ES6 and Rollup.js
:description: Bundling a .zip archive version of OpenTiny in a project using ES6 and Rollup.js
