...
:description: This class is used to serialize DOM trees into a string. Consult the OpenTiny API Documentation for more details and examples on how to use this class.
...
This class is used to serialize DOM trees into a string. Consult the OpenTiny API Documentation for more details and examples on how to use this class.
...
Consult the OpenTiny Documentation for more details on this format.|`xref:apis/tinymce.dom.serializer.adoc[Serializer]`
...
like what elements should be outputted and what attributes specific elements might have.
Consult the OpenTiny Documentation for more details on this format.
