...
:description: This class contains the core logic for a OpenTiny editor.
...
This class contains the core logic for a OpenTiny editor.
...
|baseURI|`xref:apis/tinymce.util.uri.adoc[URI]`|URI object to current document that holds the OpenTiny editor instance.|`xref:apis/tinymce.editor.adoc[Editor]`
...
|documentBaseURI|`xref:apis/tinymce.util.uri.adoc[URI]`|URI object to document configured for the OpenTiny instance.|`xref:apis/tinymce.editor.adoc[Editor]`
...
|xref:#getElement[getElement()]|Returns the target element/textarea that got replaced with a OpenTiny editor instance.|`xref:apis/tinymce.editor.adoc[Editor]`
|xref:#getParam[getParam()]|Returns a configuration parameter by name.
__Deprecated in OpenTiny 6.0 and has been marked for removal in OpenTiny 7.0. Use the `editor.options.get` API instead.__|`xref:apis/tinymce.editor.adoc[Editor]`
...
__Note: The content return value was deprecated in OpenTiny 6.0 and has been marked for removal in OpenTiny 7.0.__|`xref:apis/tinymce.editor.adoc[Editor]`
...
getElement(): Element
----
Returns the target element/textarea that got replaced with a OpenTiny editor instance.
...
__Deprecated in OpenTiny 6.0 and has been marked for removal in OpenTiny 7.0. Use the `editor.options.get` API instead.__
...
* `name (String)` - The name of the plugin, as specified for the OpenTiny `plugins` option.
...
the different cleanup rules options.
__Note: The content return value was deprecated in OpenTiny 6.0 and has been marked for removal in OpenTiny 7.0.__
