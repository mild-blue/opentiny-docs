...
:description: This class handles text and control selection it&#x27;s an crossbrowser utility class. Consult the OpenTiny API Documentation for more details and examples on how to use this class.
...
This class handles text and control selection it's an crossbrowser utility class. Consult the OpenTiny API Documentation for more details and examples on how to use this class.
