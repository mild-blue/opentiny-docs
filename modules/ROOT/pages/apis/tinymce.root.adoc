= tinymce
:navtitle: tinymce
:description: OpenTiny core class.
...
|baseURI|`xref:apis/tinymce.util.uri.adoc[URI]`|Absolute baseURI for the installation path of OpenTiny.|`xref:apis/tinymce.root.adoc[tinymce]`
|baseURL|`String`|Base URL where the root directory if OpenTiny is located.|`xref:apis/tinymce.root.adoc[tinymce]`
...
|majorVersion|`String`|Major version of OpenTiny build.|`xref:apis/tinymce.root.adoc[tinymce]`
|minorVersion|`String`|Minor version of OpenTiny build.|`xref:apis/tinymce.root.adoc[tinymce]`
|releaseDate|`String`|Release date of OpenTiny build.|`xref:apis/tinymce.root.adoc[tinymce]`
