...
:description: I18n class that handles translation of OpenTiny UI. Uses po style with csharp style parameters.
:keywords: add, getCode, hasCode, isRtl, setCode, translate
:moxie-type: api

I18n class that handles translation of OpenTiny UI. Uses po style with csharp style parameters.
