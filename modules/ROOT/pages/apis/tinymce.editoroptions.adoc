...
:description: OpenTiny Editor Options API. The options API provides the ability to register, lookup and set editor options.
:keywords: get, isRegistered, isSet, register, set, unset
:moxie-type: api

OpenTiny Editor Options API. The options API provides the ability to register, lookup and set editor options.
...
|xref:#register[register()]|Register a new option that can be used within OpenTiny.|`xref:apis/tinymce.editoroptions.adoc[EditorOptions]`
...
----
Register a new option that can be used within OpenTiny.
