= Bundling a .zip version of OpenTiny with CommonJS and Browserify
:navtitle: CommonJS and a .zip archive
:description_short: Bundling a .zip archive version of OpenTiny in a project using CommonJS and Browserify
:description: Bundling a .zip archive version of OpenTiny in a project using CommonJS and Browserify
