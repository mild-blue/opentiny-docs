= Context Menu Items Available for OpenTiny
...
For information on customizing the context menu and adding custom context menu sections, see: xref:contextmenu.adoc#available-context-menu-sections[Context menu].
