= Bundling an npm version of OpenTiny with ES6 and Webpack
:navtitle: ES6 and npm
:description_short: Bundling an npm version of OpenTiny in a project using ES6 and Webpack
:description: Bundling an npm version of OpenTiny in a project using ES6 and Webpack
