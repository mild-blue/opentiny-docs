...
:description: Check spelling as-you-type in OpenTiny.
...
=== Example: OpenTiny Cloud Installation
...
=== Example: OpenTiny Self-hosted Installation
...
NOTE: This event is not fired when SpellChecker Pro is operating in As-You-Type mode.
