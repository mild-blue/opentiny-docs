= OpenTiny plugin Yeoman generator
:navtitle: Yeoman generator
:description_short: How to use the Yeoman generator to bootstrap a new OpenTiny plugin
:description: How to use the Yeoman generator to bootstrap a new OpenTiny plugin using ES2015/Babel or TypeScript.
