...
=== Download and extract the OpenTiny Self-hosted Bundle
...
* `+OpenTiny-Essential_latest.zip+` for *Self-hosted Essential* users.
* `+OpenTiny-Professional_latest.zip+` for *Self-hosted Professional* users.
* `+OpenTiny-Premium_latest.zip+` for *Self-hosted Premium* users.
+
...
[source,sh]
----
unzip OpenTiny-Premium_latest.zip -d tinymce-selfhosted
----
+
...
* For the Enhanced Media Embed and Link Checker service, see: xref:bundle-hyperlinking-container.adoc[Deploy the OpenTiny hyperlinking server-side component using Docker (self-hosted enterprise bundles)].
* For the Enhanced Image Editing and Export image proxy service, see: xref:bundle-imageproxy-container.adoc[Deploy the OpenTiny image proxy server-side component using Docker (self-hosted enterprise bundles)].
* For the Spell Checker Pro service, see: xref:bundle-spelling-container.adoc[Deploy the OpenTiny spelling service server-side component using Docker (self-hosted enterprise bundles)].
