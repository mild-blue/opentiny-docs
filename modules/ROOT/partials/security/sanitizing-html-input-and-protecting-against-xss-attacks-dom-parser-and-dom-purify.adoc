...
Previously, before HTML content was passed to {productname} 5.x, it was parsed using an https://github.com/mild-blue/opentiny/blob/release/5.10/modules/tinymce/src/core/main/ts/api/html/SaxParser.ts[in-house developed API], `SaxParser`.
