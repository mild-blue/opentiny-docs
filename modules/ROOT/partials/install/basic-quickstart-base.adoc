...
== Install OpenTiny using {sourcename}
...
== Initialize OpenTiny as part of a web form
...
Adding this content to an HTML file and opening it in a web browser will load a OpenTiny editor, such as:
