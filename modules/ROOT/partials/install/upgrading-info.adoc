...
* xref:upgrading-tinymce-self-hosted-using-a-package-manager[Upgrading OpenTiny Self-hosted using a package manager].
endif::[]
* xref:upgrading-tinymce-self-hosted-manually[Upgrading OpenTiny Self-hosted manually].
...
=== Upgrading OpenTiny Self-hosted using a package manager
