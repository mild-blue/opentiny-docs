...
For information on creating advanced configurations for the third-party OpenTiny Ruby on Rails integration, visit the project on GitHub: https://github.com/spohlenz/tinymce-rails[Rails Integration for OpenTiny].
endif::[]
