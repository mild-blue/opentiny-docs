...
----
<!DOCTYPE html> <!-- Required for OpenTiny to function as intended -->
<html>
  <head>
    <meta charset="UTF-8">
  ...
  <body>
    ...
    <!-- Text area matching the selector specified in the OpenTiny configuration -->
    <textarea id="my-expressjs-{prodnamecode}-app">Hello, World!</textarea>

    <!-- Script element sourcing OpenTiny -->
    <script type="application/javascript" src= "/tinymce/tinymce.min.js"></script>
    <!-- Script element sourcing the OpenTiny configuration -->
