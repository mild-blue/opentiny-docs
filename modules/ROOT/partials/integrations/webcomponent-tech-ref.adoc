...
* xref:use-a-cloud-version-of-the-tinymce-web-component-integration[Use a cloud version of the OpenTiny Web Component integration]
* xref:installing-the-tinymce-web-component-integration[Installing the OpenTiny Web Component integration]
* xref:loading-tinymce[Loading OpenTiny]
...
** xref:supported-tinymce-events[Supported OpenTiny events]

[[use-a-cloud-version-of-the-tinymce-web-component-integration]]
== Use a cloud version of the OpenTiny Web Component integration
...
== Installing the OpenTiny Web Component integration
...
The `+toolbar+` attribute accepts a space-separated string of toolbar buttons with pipe characters (`+|+`) for grouping buttons. For a list of available toolbar buttons, see: xref:available-toolbar-buttons.adoc[Toolbar Buttons Available for OpenTiny].
...
The `+quickbars_insert_toolbar+` attribute accepts a space-separated string of toolbar buttons with pipe characters (`+|+`) for grouping buttons. For a list of available toolbar buttons, see: xref:available-toolbar-buttons.adoc[Toolbar Buttons Available for OpenTiny].
...
The `+quickbars_selection_toolbar+` attribute accepts a space-separated string of toolbar buttons with pipe characters (`+|+`) for grouping buttons. For a list of available toolbar buttons, see: xref:available-toolbar-buttons.adoc[Toolbar Buttons Available for OpenTiny].
...
There are two methods to bind events for the OpenTiny Web Component.
...
----
+
If these attributes are later removed, the event will be automatically unbound. For the full list of supported `+on-+` attributes, see: xref:supported-browser-events[Supported browser events] and xref:supported-tinymce-events[Supported OpenTiny events].
