...
* xref:installing-the-tinymce-angular-integration-using-npm[Installing the OpenTiny Angular integration using NPM]
* xref:using-the-tinymce-angular-integration[Using the OpenTiny Angular integration]
...
== Installing the OpenTiny Angular integration using NPM
...
== Using the OpenTiny Angular integration
...
*Possible values:* A space separated list of OpenTiny editor events.
...
* `+event+` - The OpenTiny event object.
